...
public class MainController {
	...
	public String home(Locale locale, Model model, ProductDTO dto) throws Exception {
		logger.info("Welcome home! The client locale is {}.", locale);
		Date date = new Date();
		DateFormat dateFormat = DateFormat.getDateTimeInstance(DateFormat.LONG, DateFormat.LONG, locale);
		String formattedDate = dateFormat.format(date);
		model.addAttribute("serverTime", formattedDate);
		model.addAttribute("productMain",service.getProductMain(dto));
		model.addAttribute("productSale",service.getProductSale(dto));
		return "main";
	}
	...
	public String logoClick(Model model, ProductDTO dto) throws Exception {
		model.addAttribute("productMain",service.getProductMain(dto));
		model.addAttribute("productSale",service.getProductSale(dto));
		return "main";
	}
